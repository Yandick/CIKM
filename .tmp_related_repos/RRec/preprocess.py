...
def _download_raw(path: str, type: str = "review", category: str = "Movies_and_TV", verbose=True) -> str:
    """
    ...
    if not os.path.exists(local_filepath):
        ...
        print(f"{os.path.basename(local_filepath)} already exists. Skipping download.")
